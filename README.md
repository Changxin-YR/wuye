...
- 小区 2 个：**美家花园**（1 栋、2 栋）+ **美家花园二期**（3 栋，用于演示跨小区隔离）
- 房屋 **18** 套（美家花园 16 套 + 二期 2 套；单元 / 房号 / 面积 / 空置-自住-出租状态）
